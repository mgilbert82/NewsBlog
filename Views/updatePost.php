...
<div class="container mt-2">
    ...
    <form method="post">
        ...
        <input type="text" name="title" class="form-control" placeholder="<?= $post->getTitle(); ?>">
        ...
        <input type="image_url" name="image_url" class="form-control" placeholder="<?= $post->getImage_url(); ?>">
